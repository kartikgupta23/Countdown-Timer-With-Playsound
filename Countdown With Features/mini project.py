...
class CountDown:
    def __init__(self, root):
        ...
        self.hour_combobox = ttk.Combobox(self.window, \
        width=8, height=10, textvariable=self.hour, \
        ...
        self.minute = IntVar()
        self.minute_combobox = ttk.Combobox(self.window, \
        width=8, height=10, textvariable=self.minute, \
        font=("times new roman",15))
        ...
        self.second = IntVar()
        self.second_combobox = ttk.Combobox(self.window, \
        width=8, height=10, textvariable=self.second, \
        font=("times new roman",15))
    ...
    def Get_Time(self):
        ...
        try:
            ...
            # If the user try to set the default 
    ...
    def start_time(self):
        ...
        while self.time_left > 0:
            ...
            if self.time_left <= 0:
                ...
                args=('Diamond Eyes - Flutter [NCS Release].mp3',))
